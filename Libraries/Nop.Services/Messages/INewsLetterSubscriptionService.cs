...
namespace Nop.Services.Messages
{
    ...
    public partial interface INewsLetterSubscriptionService
    {
        ...
        IPagedList<NewsLetterSubscription> GetAllNewsLetterSubscriptions(string phone = null,string email = null,
            DateTime? createdFromUtc = null, DateTime? createdToUtc = null,
            int storeId = 0, bool? isActive = null, int customerRoleId = 0,
            int pageIndex = 0, int pageSize = int.MaxValue);


        IPagedList<NewsLetterSubscription> GetNewsLetterSubscriptionByNameAndStoreId(string name, int storeId, int pageIndex = 0, int pageSize = int.MaxValue);
        NewsLetterSubscription GetNewsLetterSubscriptionByPhoneAndStoreId(string phone, int storeId);
    }
}
