...
namespace Nop.Services.Messages
{
    public partial interface IWorkflowMessageService
    {
        ...
        /// <returns>Queued email identifier</returns>
        int SendContactUsMessage(int languageId, string senderEmail = null, string senderName = null, string subject = null, string body = null, string senderPhone = null);
        ...
        void SendNewsLetterSubscriptionMsgForAdmin(NewsLetterSubscription subscription, int languageId);
    }
}
