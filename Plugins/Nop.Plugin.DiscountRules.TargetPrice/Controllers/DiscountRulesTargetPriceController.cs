...
using Nop.Plugin.DiscountRules.TargetPrice.Models;
using Nop.Services;
...
namespace Nop.Plugin.DiscountRules.TargetPrice.Controllers
{
    [AdminAuthorize]
    public class DiscountRulesTargetPriceController : BasePluginController
    {
        ...
        public DiscountRulesTargetPriceController(IDiscountService discountService,
        ...
        public ActionResult Configure(int discountId, int? discountRequirementId)
        {
            ...
            //add a prefix
            ViewData.TemplateInfo.HtmlFieldPrefix = string.Format("DiscountRulesTargetPrice{0}", discountRequirementId.HasValue ? discountRequirementId.Value.ToString() : "0");

            return View("~/Plugins/DiscountRules.TargetPrice/Views/DiscountRulesTargetPrice/Configure.cshtml", model);
        }
        ...
        public ActionResult Configure(int discountId, int? discountRequirementId, string productIds)
        {
            ...
            else
            {
                ...
                {
                    DiscountRequirementRuleSystemName = "DiscountRequirement.TargetPrice"
                };
        ...
        public ActionResult ProductAddPopup(string btnId, string productIdsInput)
        {
            ...
            return View("~/Plugins/DiscountRules.TargetPrice/Views/DiscountRulesTargetPrice/ProductAddPopup.cshtml", model);
        }
