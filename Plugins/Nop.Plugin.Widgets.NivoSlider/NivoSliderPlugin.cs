...
namespace Nop.Plugin.Widgets.NivoSlider
{
    ...
    public class NivoSliderPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public override void Install()
        {
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Widgets.NivoSlider.Picture9", "Picture 9");
            this.AddOrUpdatePluginLocaleResource("Plugins.Widgets.NivoSlider.Picture10", "Picture 10");
