...
namespace Nop.Admin.Models.Catalog
{
    ...
    public partial class ProductModel : BaseNopEntityModel, ILocalizedModel<ProductLocalizedModel>
    {
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.WeightProduct")]
        public bool WeightProduct { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.weightUnit")]
        public string WeightUnit { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.UnitPrice")]
        [UIHint("DecimalNullable")]
        public decimal? UnitPrice { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ByUnit")]
        /// <summary>
        /// Gets or sets if prod sells by units too
        /// </summary>
        public bool? ByUnit { get; set; }
        //[AllowNulls]
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.BaseWeight")]
        [UIHint("DecimalNullable")]
        /// <summary>
        /// Gets or sets base weight for weight for selling by weight
        /// </summary>
        public decimal? BaseWeight { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.Zap")]
        public bool Zap { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ZapMODEL")]
        public string ZapMODEL { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ZapDETAILS" )]
        public string ZapDETAILS { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ZapCURRENCY")]
        public string ZapCURRENCY { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ZapSHIPMENT_COST")]
        public string ZapSHIPMENT_COST { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ZapDELIVERY_TIME")]
        public string ZapDELIVERY_TIME { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ZapMANUFACTURER")]
        public string ZapMANUFACTURER { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ZapWARRANTY")]
        public string ZapWARRANTY { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ZapIMAGE")]
        public string ZapIMAGE { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ZapTAX")]
        public string ZapTAX { get; set; }
