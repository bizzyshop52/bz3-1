...
namespace Nop.Web.Controllers
{
    public partial class CommonController : BasePublicController
    {
        ...
        [StoreClosed(true)]
        [Route("{body}/contact/")]
        public virtual ActionResult ContactUs(string body)
        {
            ...
            {
                model.Subject = body;
                model.Enquiry = "אבקש כי תחזרו אלי בקשר למוצר זה" +"\n" + body;
            }
        ...
        [NopHttpsRequirement(SslRequirement.No)]
        public virtual ActionResult Zap()
        {
            if (!_storeContext.CurrentStore.zapEnabled)
                return RedirectToRoute("HomePage");

          //  var model = _si;
            return Redirect("/zap.html"); ;
        }
