...
namespace Nop.Web.Factories
{
    ...
    public partial class OrderModelFactory : IOrderModelFactory
    {
        ...
        public virtual OrderDetailsModel PrepareOrderDetailsModel(Order order)
        {
            ...
            {
                //decimal BaseWeight = orderItem.Product.BaseWeight.HasValue ? orderItem.Product.BaseWeight.Value : 0;
                //decimal UnitPriceWeight = orderItem.Product.UnitPrice.HasValue ? orderItem.Product.UnitPrice.Value : 0;
                var orderItemModel = new OrderDetailsModel.OrderItemModel
                {
                    ...
                    UnitPriceWeight = orderItem.Product.UnitPrice,
