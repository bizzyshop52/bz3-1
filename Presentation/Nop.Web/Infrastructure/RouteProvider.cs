...
namespace Nop.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            //routes.MapLocalizedRoute("AddProductToCart-Catalog_Weight",
            //             "addproducttocart_Weight/catalog/{productId}/{shoppingCartTypeId}/{decQuantity}",
            //             new { controller = "ShoppingCart", action = "AddProductToCart_Catalog_Weight" },
            //             new { productId = @"\d+", shoppingCartTypeId = @"\d+", decQuantity = @"\d+" },
            //             new[] { "Nop.Web.Controllers" });


            routes.MapLocalizedRoute("products/{productId}",
               "Products/{productId}",
            ...
            routes.MapLocalizedRoute("contactusproduct/{body}",
                "Contactusproduct/{body}",
            ...
            //zap
            routes.MapLocalizedRoute("Zap",
                            "zap",
                            new { controller = "Common", action = "Zap" },
                            new[] { "Nop.Web.Controllers" });
